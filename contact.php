...
<head>
    <meta charset="utf-8" />
    <title>Daniel Patrício Lara Cabezas</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Daniel Patrício Lara Cabezas" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Daniel Patrício Lara Cabezas" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/jpsf.jpg" alt="Jose Pereira da Silva Filho">
                    </div>
                    <div class=" header__base-info">
                        <h4 class="title titl--h4">Daniel Patrício Lara Cabezas</h4>
                        <div class="status">Desenvolvedor de WEB</div>
                        <ul class="header__social">
                            <li>
                                <a
                                    href="https://www.linkedin.com/in/daniel-patricio-cabezas-5018abb0/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BZQG8TpalSeq5vzo%2ByyjKGA%3D%3D/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/lara1000106">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            email.santiago23@santiago.com
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55 11 97993-7803">+55 (11) 97993-7803 </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Daniel Patrício Lara Cabezas</footer>
                </div>
            </div>
        </div>
    </main>
